...
const ShoppingListPage: React.FC = () => {
  ...
  const { currentWeek, loading, generating, error, successMessage, addModalOpen } = useAppSelector((state) => state.shoppingList);
  const itemsByCategory = useAppSelector(selectShoppingListByCategory);
