...
const BrowseRecipesPage: React.FC = () => {
  ...
  const pagination = useAppSelector(selectBrowsePagination);
  ...
  const handleFilterChange = useCallback((newFilters: any): void => {
  ...
  const handleIngredientSearch = useCallback((ingredientText: string): void => {
