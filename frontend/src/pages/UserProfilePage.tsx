...
const UserProfilePage: React.FC = () => {
  ...
  const [counts, setCounts] = useState<{ followers_count: number; following_count: number }>({ followers_count: 0, following_count: 0 });
  const [activeTab, setActiveTab] = useState<string>('recipes'); // recipes, followers, following
